 ...
 * @return
 */
static int usteer_ubus_get_clients(struct ubus_context *ctx, struct ubus_object *obj,
 ...
 * @return
 */
static int usteer_ubus_get_client_info(struct ubus_context *ctx, struct ubus_object *obj,
                                       struct ubus_request_data *req, const char *method,
                                       struct blob_attr *msg){
	struct sta_info *si;
	struct sta *sta;
 ...
 * @return
 */
static int usteer_ubus_get_config(struct ubus_context *ctx, struct ubus_object *obj,
                                  struct ubus_request_data *req, const char *method,
                                  struct blob_attr *msg){
	int i;
 ...
 * @return
 */
static int usteer_ubus_set_config(struct ubus_context *ctx, struct ubus_object *obj,
                                  struct ubus_request_data *req, const char *method,
                                  struct blob_attr *msg){
 ...
 * @param node
 */
static void usteer_dump_node_info(struct usteer_node *node){
	void *c;
 ...
 * @return
 */
static int usteer_ubus_local_info(struct ubus_context *ctx, struct ubus_object *obj,
                                  struct ubus_request_data *req, const char *method,
                                  struct blob_attr *msg){
 ...
 * @return
 */
static int usteer_ubus_remote_info(struct ubus_context *ctx, struct ubus_object *obj,
                                   struct ubus_request_data *req, const char *method,
                                   struct blob_attr *msg){
 ...
 * @param node
 */
static void usteer_add_nr_entry(struct usteer_node *ln, struct usteer_node *node){
